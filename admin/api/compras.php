...
/* La re-confirmacion de contrasena vive en _lib/reconfirmar.php: la
   necesita tambien borrado_final.php, y este archivo es un endpoint
   que no se puede incluir desde ningun lado. */
