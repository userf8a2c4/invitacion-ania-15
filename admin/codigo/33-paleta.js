...
/** Los que trae la app de fábrica (estilos/01-fundamentos.css). */
const PALETA_ORIGINAL = { principal: '#d4a843', fondo: '#140a04', alerta: '#cf5b52' };

/* La mayoría de la gente no quiere elegir colores: quiere elegir un
   look. Estas son cuatro combinaciones ya probadas; abajo, para quien
   quiera, están los selectores sueltos. */
const PALETAS_LISTAS = [
  { nombre: 'Dorado y café (original)', principal: '#d4a843', fondo: '#140a04', alerta: '#cf5b52' },
