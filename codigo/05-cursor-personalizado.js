...
(function preparaElCursorPersonalizado() {
  ...
  function laEscenaEstaQuieta() {
    ...
    return !!(registro && registro.cursor);
  }

  function dibujarCuadro() {
    /* Congelado: el anillo y el punto se quedan donde estén. No hace falta
       poner el reloj al día porque la persecución es proporcional a lo que
       falta, no al tiempo: al soltar, alcanza al mouse con la misma curva
       de siempre. */
    if (laEscenaEstaQuieta()) {
